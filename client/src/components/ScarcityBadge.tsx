...
export default function ScarcityBadge({ stockCount = 3, isSold = false }: ScarcityBadgeProps) {
  ...
  return (
    ...
    >
      <AlertTriangle size={14} className={isVeryLowStock ? 'text-red-400' : 'text-yellow-400'} />
      <span className="text-xs font-medium uppercase tracking-widest">
        {isVeryLowStock
          ? '1 of 1 remaining'
          : `Only ${stockCount} pieces left`
        }
      </span>
    </motion.div>
  );
