    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-yellow-400 selection:text-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-20 text-center px-4">
          ...
          >
            Owned by a <span className="italic text-yellow-500">few</span>,{" "}
            <br />
            not by everyone.
          </motion.h1>
          <motion.p
          ...
          >
            <Link
              href="/products"
              className="px-10 py-4 bg-yellow-400 text-black font-bold uppercase tracking-widest hover:bg-yellow-300 transition-all rounded-full flex items-center justify-center gap-2 group"
            >
              Explore Collection{" "}
              <ChevronRight
                size={20}
            ...
            <Link
              href="/stories"
              className="px-10 py-4 border border-white/20 backdrop-blur-md hover:bg-white/10 transition-all rounded-full uppercase tracking-widest text-sm flex items-center justify-center gap-2"
            >
